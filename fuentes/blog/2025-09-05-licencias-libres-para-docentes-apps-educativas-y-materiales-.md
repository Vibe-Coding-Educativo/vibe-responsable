---
titulo: Licencias libres para docentes: apps educativas y materiales didácticos
...
- [Licencias para código (si creas aplicaciones o herramientas)](https://educacion.bilateria.org/licencias-libres-para-docentes-apps-educativas-y-materiales-didacticos/#Licencias_para_codigo_si_creas_aplicaciones_o_herramientas)
- [Tablas comparativas](https://educacion.bilateria.org/licencias-libres-para-docentes-apps-educativas-y-materiales-didacticos/#Tablas_comparativas)
- [Combinaciones recomendadas según tu objetivo](https://educacion.bilateria.org/licencias-libres-para-docentes-apps-educativas-y-materiales-didacticos/#Combinaciones_recomendadas_segun_tu_objetivo)
- [Casos prácticos para docentes](https://educacion.bilateria.org/licencias-libres-para-docentes-apps-educativas-y-materiales-didacticos/#Casos_practicos_para_docentes)
- [Preguntas frecuentes de docentes](https://educacion.bilateria.org/licencias-libres-para-docentes-apps-educativas-y-materiales-didacticos/#Preguntas_frecuentes_de_docentes)
- [Cómo aplicar las licencias](https://educacion.bilateria.org/licencias-libres-para-docentes-apps-educativas-y-materiales-didacticos/#Como_aplicar_las_licencias)
- [Recomendación final](https://educacion.bilateria.org/licencias-libres-para-docentes-apps-educativas-y-materiales-didacticos/#Recomendacion_final)
- [Generador de licencias para recursos educativos abiertos (REA)](https://educacion.bilateria.org/licencias-libres-para-docentes-apps-educativas-y-materiales-didacticos/#Generador_de_licencias_para_recursos_educativos_abiertos_REA)
- [Vídeo resumen creado por NotebookLM](https://educacion.bilateria.org/licencias-libres-para-docentes-apps-educativas-y-materiales-didacticos/#Video_resumen_creado_por_NotebookLM)
...
<td style="padding: .6rem">✅ <strong>Sí, parcial</strong></td>
<td style="padding: .6rem">Copyleft moderado</td>
<td style="padding: .6rem">Adecuada para colaboración entre docentes, equilibrando retorno y flexibilidad</td>
</tr>
<tr style="border-top:1px solid #e5e7eb;">
<td style="padding: .6rem"><strong>Apache 2.0</strong></td>
<td style="padding: .6rem">❌ <strong>No</strong></td>
<td style="padding: .6rem">Adopción sin barreras</td>
<td style="padding: .6rem">Útil para instituciones que buscan adopción amplia sin exigir retorno obligatorio</td>
</tr>
<tr style="border-top:1px solid #e5e7eb;">
...
<tbody>
<tr style="border-top:1px solid #e5e7eb;">
<td style="padding: .6rem"><strong>CC BY-SA</strong></td>
<td style="padding: .6rem">✅ <strong>Sí</strong></td>
<td style="padding: .6rem">✅ Sí</td>
<td style="padding: .6rem">✅ Sí</td>
<td style="padding: .6rem"><strong>Ideal</strong> – Fomenta intercambio educativo</td>
</tr>
<tr style="border-top:1px solid #e5e7eb;">
<td style="padding: .6rem"><strong>CC BY</strong></td>
<td style="padding: .6rem">❌ <strong>No</strong></td>
<td style="padding: .6rem">✅ Sí</td>
<td style="padding: .6rem">✅ Sí</td>
<td style="padding: .6rem">Buena para máxima difusión</td>
</tr>
<tr style="border-top:1px solid #e5e7eb;">
<td style="padding: .6rem"><strong>CC BY-NC-SA</strong></td>
<td style="padding: .6rem">✅ <strong>Sí</strong></td>
<td style="padding: .6rem">❌ No</td>
<td style="padding: .6rem">✅ Sí</td>
<td style="padding: .6rem">Problemática – “Comercial” genera ambigüedades</td>
</tr>
</tbody>
</table>
</div>
...
<tr>
<td>AGPL v3</td>
<td><a href="https://www.gnu.org/licenses/agpl-3.0.html">https://www.gnu.org/licenses/agpl-3.0.html</a></td>
</tr>
<tr>
<td>MPL 2.0</td>
...
Elige las licencias recomendadas para contenidos y/o código y genera un prompt listo para pedir el texto de licencia (README / página web).

Reciprocidad (recomendado)

Máxima adopción

Intermedia

Tipo de recurso Ambos (contenidos + código) Solo contenidos educativos Solo código (apps/herramientas)

Licencias para contenidos educativos [ CC BY-SA 4.0 --- Atribución + compartir igual (recomendada)] [ CC BY 4.0 --- Atribución] [ CC BY-NC-SA 4.0 --- No comercial (con reservas)]
...
Licencias para código [ AGPL v3 --- Copyleft fuerte orientado a red (recomendada)] [ MPL 2.0 --- Copyleft moderado] [ Apache 2.0 --- Adopción amplia] [ MIT --- Simplicidad]

Dónde enlazar la licencia del código (solo para el prompt IA)

[ Crear LICENSE.txt y enlazar al archivo] [ Enlazar al sitio oficial de la licencia]
...
Datos opcionales para atribución

[Título o proyecto] [Autoría] [Año] [URL del recurso] [Enlace del autor] [Idioma]

Resultados generados

Borrar datos

Copia el formato que necesites: prompt para IA, texto listo para pegar o HTML con enlaces.

### [Prompt para IA] [(para pedir a una IA que redacte el aviso)]

Copiar

### [Texto plano] [(para pegar directamente en documentos o webs)]

Copiar

### [Bloque HTML] [(para incrustar en tu página con enlaces oficiales)]

Copiar

Licencias incluidas (enlaces oficiales)
...
[Licencia: ][AGPL v3](LICENSE.txt)

([Ver la aplicación en una pestaña nueva](https://jjdeharo.github.io/licencias-libres/))
...
- [](https://telegram.me/share/url?url=https%3A%2F%2Feducacion.bilateria.org%2Flicencias-libres-para-docentes-apps-educativas-y-materiales-didacticos&text=Licencias%20libres%20para%20docentes%3A%20apps%20educativas%20y%20materiales%20did%C3%A1cticos "Compartir en Telegram")
- [](https://api.whatsapp.com/send?text=https%3A%2F%2Feducacion.bilateria.org%2Flicencias-libres-para-docentes-apps-educativas-y-materiales-didacticos%20Licencias%20libres%20para%20docentes%3A%20apps%20educativas%20y%20materiales%20did%C3%A1cticos "Compartir en Whatsapp")
