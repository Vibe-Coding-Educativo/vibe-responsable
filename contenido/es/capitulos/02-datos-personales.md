...
- **El alumnado se identifica con un código.** El programa no pide el nombre, sino un código que solo el docente sabe a qué persona corresponde. El Reglamento europeo llama a esta técnica seudonimización, y exige que esa correspondencia se guarde por separado. En [PCD](https://jjdeharo.github.io/pcd/), una plantilla correctora para exámenes tipo test, el único campo de identificación admite un código en lugar del nombre.
