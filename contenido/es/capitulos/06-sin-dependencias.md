...
Estas dependencias no se ven al usar el material. Se descubren al leer el código o al pedir a la IA que las enumere, que es lo que hace el punto 6 del texto de revisión de las [instrucciones para la IA](para-la-ia.html).

## Los cambios en los servicios externos

Un servicio externo puede cambiar sus condiciones, pasar a ser de pago o cerrar, y el material que dependía de él deja de funcionar sin que su autor haya tocado nada. El artículo del CEDEC [«Mantener la "A" de abierto en los REA en tiempos de IA»](https://cedec.intef.es/mantener-la-a-de-abierto-en-los-rea-en-tiempos-de-ia/) lo ilustra con el caso de un recurso que incrusta un mapa interactivo de una plataforma externa. Si la plataforma retira las presentaciones gratuitas, el recurso muestra un recuadro en blanco, y el docente no puede recuperar el contenido porque no tiene el archivo original. El artículo recomienda reservar el contenido incrustado para los vídeos y casos similares.
