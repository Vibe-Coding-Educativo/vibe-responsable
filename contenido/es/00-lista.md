...
El vibe coding, [nombre propuesto por Andrej Karpathy en febrero de 2025](https://x.com/karpathy/status/1886192184808149383), consiste en crear programas informáticos explicando a un modelo de inteligencia artificial lo que se quiere obtener, sin necesidad de saber programar. En educación, permite al profesorado crear sus propios recursos digitales, como simuladores, cuestionarios o juegos interactivos, adaptados a lo que necesita en su aula. La persona aporta la intención pedagógica y comprueba el resultado, mientras que la IA escribe el código. Es una práctica cada vez más extendida, que cuenta con comunidades docentes como el grupo de Telegram [Vibe Coding Educativo](https://t.me/vceduca), donde se comparten ejemplos, dudas y soluciones.
