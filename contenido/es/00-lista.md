...
A efectos de esta guía no importa tanto la herramienta como dos cuestiones, que son dónde queda alojado el material y si se puede obtener su código. En las dos primeras familias el material vive en los servidores de una empresa, que decide cuánto tiempo se mantiene, y el código no siempre está disponible. En las dos últimas el código queda en manos de quien lo crea y puede publicarse en un sitio propio o en un repositorio como [GitHub](https://github.com/), lo que da mucho más margen. Por este motivo, cada recomendación indica lo mínimo, que puede cumplirse en cualquier caso, y lo que conviene añadir cuando se dispone del código. Quien utilice una plataforma que permite descargarlo se encuentra también en este segundo caso. En el artículo [«Consolas de IA: qué son y cómo se instalan»](https://educacion.bilateria.org/consolas-de-ia-en-2026-que-son-como-se-instalan-y-que-cuestan-ahora/) se explica cómo empezar a trabajar con los agentes de programación.
