...
- **Lo recomendado.** Llevar un registro de decisiones dentro del proyecto, una por archivo, con el contexto, las alternativas descartadas y las consecuencias. El control de versiones conserva, además, la historia de los cambios.
