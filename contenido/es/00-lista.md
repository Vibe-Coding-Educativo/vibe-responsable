...
Crear una aplicación o un recurso educativo con ayuda de la inteligencia artificial está hoy al alcance de cualquier docente. Publicarlo para que lo use el alumnado u otras personas añade una responsabilidad que no depende de saber programar, sino de comprobar unas pocas cosas antes de compartirlo. Esta lista reúne las diez recomendaciones de la guía, de forma que también sirve para revisar un material que ya está hecho. Cada una enlaza con el capítulo donde se explica con más detalle.

No todas las personas trabajan con los mismos medios. Quien crea sus materiales dentro de la web de un chatbot tiene menos margen que quien publica el código en un sitio propio, ya que la aplicación suele quedar alojada en la plataforma y no siempre puede sacarse de ella. Por este motivo, cada recomendación indica lo mínimo, que puede cumplirse en cualquier caso, y lo que conviene añadir cuando se dispone del código. Las tres primeras son las esenciales y el resto son recomendables, por lo que conviene empezar por ellas.
